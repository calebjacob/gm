...
- **Routes** (in `app/routes.ts`):
  ...
  - `/campaigns/:id` — **Campaign view**: campaign name, ruleset/world names, party (list of characters), main campaign chat (message list + input; stream tokens). Entry point to add characters and to view/interact with campaign chat.
